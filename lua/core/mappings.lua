...
M.misc = function()
   local function non_config_mappings()
      ...
      map_wrapper("n", "<Leader><CR>", ":noh <CR>")
...
M.bufferline = function()
   ...
   map("n", m.buffer_pick, ":BufferLinePick <CR>")
   map("n", m.buffer_pick_close, ":BufferLinePickClose <CR>")
end
...
M.nvimtree = function()
   ...
   map("n", plugin_maps.nvimtree.find_file, ":NvimTreeFindFile <CR>")
end
...
M.telescope = function()
   ...
   map("n", m.marks, ":Telescope marks <CR>")
